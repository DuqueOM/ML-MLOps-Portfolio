...
[BankChurn Predictor](projects/bankchurn.md){ .portfolio-button .portfolio-button--primary }
[NLPInsight Analyzer](projects/nlpinsight.md){ .portfolio-button .portfolio-button--primary }
[ChicagoTaxi Pipeline](projects/chicagotaxi.md){ .portfolio-button .portfolio-button--primary }
[Production Template](template.md){ .portfolio-button .portfolio-button--primary }
</div>
</div>
...
Every claim on this page maps to inspectable evidence: source files, tests,
screenshots, ADRs, deployment notes and written trade-offs. Nothing here asks
...
<p><strong>Main signal:</strong> R² 0.96, 6.3M rows processed and leakage removed
...
into a reusable starter system — including a governed AI-assisted development
layer (rules, skills, audit trail) that keeps agentic coding reviewable.</p>
...
[Read debugging deep dive](projects/bankchurn-debugging.md){ .portfolio-button }
</div>
