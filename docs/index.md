...
<!-- This page renders through overrides/home.html (custom landing
     experience). The markdown body below is indexed by site search
     but not rendered — edit overrides/home.html to change the page. -->

Duque Ortega Mutis — Building ML systems that survive production.
...
drift detection per project kind across tabular, deep learning, LLM/RAG and
agents. 14 years of operations leadership before ML. Target roles: MLOps
Engineer, Platform Engineer (ML infra), ML Engineer — evaluated on evidence,
not tenure. Mexico City.
