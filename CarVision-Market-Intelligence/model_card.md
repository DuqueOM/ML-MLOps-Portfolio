...
- **Target**: price (USD)
- **Data**: `data/raw/vehicles_us.csv` (used car listings). Source: educational dataset for analytics. See DATA_LICENSE.
...
- El dataset de base (`data/raw/vehicles_us.csv`) no contiene PII directa en este proyecto; IDs de anuncio/vendedor se eliminan para uso de portafolio.
