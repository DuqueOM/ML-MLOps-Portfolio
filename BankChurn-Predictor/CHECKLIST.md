...
## Code Quality
- [ ] **Linting**: `flake8` passes without errors.
...
- [ ] **Integration**: `make docker-demo` runs locally without crashing.
...
## Artifacts
- [ ] **Reproducibility**: `make train` runs successfully from scratch.
